...
# validation using all 2018 data, 50 replications
...
# Based on external_crossvalidation_evaluation.R (train on 70% of 2010-2017, test on all 2018, 50 replications)
#
...
# --- Save results ---
write_xlsx(final_sheets, "output/revision/Analysis3_v6_HAC_results.xlsx")
