...
7. internal_crossvalidation_evaluation_sensanalysis.R performs the same analyses and assessments as internal_crossvalidation_evaluation.R, but includes participants with missing hospital-acquired conditions (HAC).